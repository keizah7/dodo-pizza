...
document.querySelectorAll('.header__trigger').forEach(function (item) {
  return item.addEventListener('click', toggleMobileNav);
});
...
function closeGroupModal() {
  var x = document.querySelector('.modal__close');

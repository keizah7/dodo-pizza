...
@section('content')
    ...
    <section class="section">
        <div class="container-fluid columns">
            <form action="{{ route('dashboard.group.store') }}" method ="POST" class="column is-one-third">
                @csrf

                <div class="field">
                    <label class="label">@lang('dashboard.data.title')</label>
                    <div class="control">
                        <input value="{{ old('title') }}" name="title" class="input" group="text" placeholder="@lang('dashboard.data.title.placeholder')" required>
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input value="{{ old('priority') }}" name="priority" class="input" group="number" placeholder="0" required>
                    </div>

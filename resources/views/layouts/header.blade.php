<header class="header">
    <div class="header__content till-lg">
        <div class="flex">
            <div class="header__logo">
                <a href=""><img src="/img/logo.jpg" alt="Logotipas"></a>
                <a href=""><img src="/img/logo-black.jpg" alt="Logotipas"></a>
            </div>
    ...
    <div class="header__content from-lg">
        <div class="grid">
            <a href=""><img src="/img/logotipas.png" alt="Logotipas"></a>

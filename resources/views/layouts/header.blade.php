<header class="header">
    <div class="header__content till-lg">
        <div class="flex">
            <div class="header__logo">
                <a href="{{ route('index') }}"><img src="/img/logo.jpg" alt="Logotipas"></a>
                <a href="{{ route('index') }}"><img src="/img/logo-black.jpg" alt="Logotipas"></a>
            </div>
            <div class="header__trigger">
                <img src="/img/toggle.svg" alt="Atidaryti meniu">
                <img src="/img/close.svg" alt="Uždaryti meniu">
            </div>
        </div>
    ...
    <div class="header__content from-lg">
        <div class="grid">
            <a href="{{ route('index') }}"><img src="/img/logotipas.png" alt="Logotipas"></a>
...
<nav class="nav from-lg">
    <div class="nav__content">
        <div class="nav__links">
            <div class="nav__logo"><a href="/"><img src="/img/dodo.png" alt="Logo"></a></div>
            <a href="#">Akcijos</a>
            <a href="#">Kontaktai</a>
